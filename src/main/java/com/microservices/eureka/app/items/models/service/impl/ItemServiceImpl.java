...
public class ItemServiceImpl implements ItemService {
	...
	public List<Item> findAll() {
		List<Product> productos = Arrays.asList(restClient.getForObject("http://products-service/products/product-list", Product[].class));
	...
	public Item findById(Long id, Integer cantidad) {
		...
		Product producto = restClient.getForObject("http://products-service/products/{id}", Product.class, pathVariables);
